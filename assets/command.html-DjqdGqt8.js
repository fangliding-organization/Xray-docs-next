...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,40),v={class:"custom-container tip"},m=e("p",{class:"custom-container-title"},"Подсказка",-1),x=e("p",null,[a("Если "),e("code",null,"-config"),a(" не указан, Xray попытается загрузить "),e("code",null,"config.json"),a(" из следующих мест:")],-1),p=e("li",null,"Рабочий каталог (Working Directory);",-1),h=e("code",null,"Xray.location.asset",-1);function g(b,f){const i=s("RouterLink");return t(),d("div",null,[u,e("div",v,[m,x,e("ul",null,[p,e("li",null,[a("Путь, указанный в переменной окружения "),h,a(" (см. "),r(i,{to:"/ru/config/features/env.html#%D1%80%D0%B5%D1%81%D1%83%D1%80%D1%81%D0%BD%D1%8B%D0%B5-%D1%84%D0%B0%D0%B9%D0%BB%D1%8B"},{default:l(()=>[a("Переменные окружения")]),_:1}),a(").")])])])])}const _=n(o,[["render",g],["__file","command.html.vue"]]);export{_ as default};
